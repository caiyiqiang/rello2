							...
							<div class="box-tools pull-right">
								<div class="has-feedback">
									<input type="text" class="form-control input-sm"
										   placeholder="搜索"> <a style="color: red" href="${pageContext.request.contextPath}/user/findById.do"><span class="glyphicon glyphicon-search form-control-feedback"></span></a>
								</div>
							</div>
							<!--工具栏/-->
									...
									<c:forEach items="${pageInfo.list}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<a href="${pageContext.request.contextPath}/user/findRoleByIdAndUserId.do?id=${user.id}" class="btn bg-olive btn-xs">删除角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
