...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h1>
				权限管理 <small>全部权限信息</small>
			</h1>
			<ol class="breadcrumb">
				<li><a href="../pages/main.jsp"><i
						class="fa fa-dashboard"></i>首页</a></li>
				<li><a href="permission/findAll.do">权限管理</a></li>
			...
			<div class="panel panel-default">
				...
				<div class="row data-type">
					...
					<div class="col-md-4 title">权限URL</div>
					<div class="col-md-8 data">
						<input type="text" class="form-control" placeholder="权限URL"
				...
				<div class="panel panel-default">
					...
					<table id="dataList"
						...
						<tbody>
						<c:forEach var="role" items="${permission.roles}">

							<tr>
								<td>${role.id}</td>
								<td><input type="text" size="30" value="${role.roleName}"
										   readonly="readonly"></td>
								<td><input type="text" size="30" value="${role.roleDesc}"
										   readonly="readonly"></td>
							</tr>
						</c:forEach>
