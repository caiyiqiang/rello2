            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <input readonly="readonly" type="text" class="form-control" placeholder="订单编号" value="${orders.orderNum}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input readonly="readonly" type="text" class="form-control" placeholder="路线名称" value="${orders.product.productName}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input readonly="readonly" type="text" class="form-control" placeholder="出游人数" value="${orders.peopleCount}">
                    </div>

                    <div class="col-md-2 title rowHeight2x">其他信息</div>
                    <div class="col-md-10 data rowHeight2x">
                        <textarea readonly="readonly" class="form-control" rows="3" placeholder="其他信息">
                            ${orders.orderDesc}
                        </textarea>
                    </div>
